  ...
  if (enviado) return (
    <div style={s.wrap}>
      <div style={s.card}>
        ...
        <a href="/mi-tarjeta" style={{ fontSize: 14, color: '#666', textDecoration: 'none', display: 'block', textAlign: 'center', marginTop: 16 }}>
          Volver al inicio
        </a>
      </div>
    </div>
    ...
    <div style={s.wrap}>
      <div style={s.card}>
        ...
        <div style={{ textAlign: 'center', marginTop: 20 }}>
          <a href="/mi-tarjeta" style={{ fontSize: 13, color: '#666', textDecoration: 'none' }}>
            ← Volver
          </a>
        </div>
      </div>

    ...
    <div style={s.page}>
      ...
      <section style={s.hero}>
        <div style={s.heroInner}>
          <div style={s.heroBadge}>✦ Para negocios con local, no para e-commerce</div>
      ...
      <section id="como-funciona" style={s.section}>
        <div style={s.sectionInner}>
          ...
          <div style={s.stepsGrid}>
            {[
              { num:'01', icon:'⚙️', title:'Configurá tu negocio', desc:'Ponés el nombre y el color de tu marca, y definís la regla: por ejemplo, 1 punto cada $100. Elegís qué premios das, desde un café gratis hasta un descuento del 20%.' },
              { num:'02', icon:'📲', title:'Compartí el QR', desc:'Te generamos un QR para imprimir y pegar en la caja o el mostrador. El cliente lo escanea con la cámara, carga nombre y DNI, y ya tiene su tarjeta digital.' },
              { num:'03', icon:'🎁', title:'Cargás cada venta', desc:'En cada compra, buscás al cliente por nombre o DNI desde la caja y cargás el monto. Cuando junta suficientes puntos, canjea el premio con un código que vos validás antes de entregarlo.' },
            ].map((step, i) => (
        ...
        <div style={s.sectionInner}>
          ...
          <div style={s.featuresGrid}>
            {[
              ...
              { icon:'🏪', title:'Multi-sucursal', desc:'Cada sucursal tiene su propia caja con PIN propio, pero el cliente suma puntos sin importar en qué local compre.' },
              { icon:'📊', title:'Métricas en tiempo real', desc:'Cuántos clientes tenés, quiénes son los más activos y qué sucursal vende más, todo desde el panel.' },
            ].map((f, i) => (
            ...
            {[
              {
                ...
                periodo: 'siempre',
                color: '#333',
                features: ['Hasta 50 clientes', '1 sucursal', 'Puntos, niveles y referidos', 'Caja con escáner QR', 'Tarjeta digital sin app'],
                cta: 'Empezar gratis',

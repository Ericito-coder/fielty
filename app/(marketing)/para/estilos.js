...
export const s = {
  ...
  navLink: { fontSize: 13, color: theme.gray, textDecoration: 'none', fontWeight: 500 },
  ...
  badge: { display: 'inline-block', background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: 100, padding: '7px 18px', fontSize: 12, color: theme.gray, marginBottom: 28, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em' },
  ...
  sectionSub: { fontSize: 17, color: theme.gray, lineHeight: 1.75, maxWidth: 680, marginBottom: 48 },
  ...
  otrosTexto: { fontSize: 15, color: theme.gray },
  otrosLink: { color: theme.red, fontWeight: 700, textDecoration: 'none' },

...
export const s = {
  ...
  navLink: { fontSize: 13, color: '#666', textDecoration: 'none', fontWeight: 500 },
  ...
  badge: { display: 'inline-block', background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: 100, padding: '7px 18px', fontSize: 12, color: '#666', marginBottom: 28, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em' },

...
export const s = {
  ...
  navLink: { fontSize: 13, color: theme.darkText, textDecoration: 'none', fontWeight: 500 },
  ...
  badge: { display: 'inline-block', background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: 100, padding: '7px 18px', fontSize: 12, color: theme.darkMuted, marginBottom: 28, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em' },
  ...
  heroSub: { fontSize: 18, color: theme.darkText, lineHeight: 1.75, maxWidth: 620, margin: '0 auto 36px' },
  ctaRow: { display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' },
  ctaPrimary: { background: theme.red, color: 'white', textDecoration: 'none', padding: '15px 30px', borderRadius: 14, fontSize: 16, fontWeight: 800, display: 'inline-block' },
  ...
  sectionSub: { fontSize: 17, color: theme.darkText, lineHeight: 1.75, maxWidth: 680, marginBottom: 48 },
  ...
  cardTitle: { fontSize: 17, fontWeight: 800, color: 'white', marginBottom: 10, marginTop: 0 },
  cardText: { fontSize: 14, color: theme.darkText, lineHeight: 1.8, margin: 0 },

  steps: { display: 'flex', flexDirection: 'column', gap: 28 },
  step: { display: 'flex', gap: 20, alignItems: 'flex-start' },
  stepNum: { width: 38, height: 38, borderRadius: '50%', background: theme.red, color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, fontWeight: 900, flexShrink: 0 },
  stepTitle: { fontSize: 18, fontWeight: 800, color: 'white', marginBottom: 8, marginTop: 0 },
  stepText: { fontSize: 15, color: theme.darkText, lineHeight: 1.8, margin: 0 },

  faqList: { display: 'flex', flexDirection: 'column', gap: 28 },
  faqQ: { fontSize: 17, fontWeight: 800, color: 'white', marginBottom: 8, marginTop: 0 },
  faqA: { fontSize: 15, color: theme.darkText, lineHeight: 1.8, margin: 0 },

  otros: { padding: '0 32px 60px', textAlign: 'center' },
  otrosTexto: { fontSize: 15, color: theme.darkText },
  otrosLink: { color: theme.redOnDark, fontWeight: 700, textDecoration: 'none' },

...
const s = {
  ...
  header: { background:theme.black, padding:'28px', display:'flex', alignItems:'center', justifyContent:'center', gap:10 },
  logoDot: { width:10, height:10, borderRadius:'50%', background:theme.red, boxShadow:'0 0 8px #e0001b' },
  ...
  stepNum: { width:32, height:32, borderRadius:'50%', background:theme.black, display:'flex', alignItems:'center', justifyContent:'center', color:'white', fontSize:14, fontWeight:800 },

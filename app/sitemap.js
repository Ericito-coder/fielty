...
export default function sitemap() {
  ...
  const routes = [
    { path: '/', priority: 1.0, changeFrequency: 'weekly', lastModified: '2026-07-30' },
    { path: '/para', priority: 0.9, changeFrequency: 'monthly', lastModified: '2026-07-30' },
    ...
    { path: '/faq', priority: 0.8, changeFrequency: 'monthly', lastModified: '2026-07-30' },
    { path: '/guia', priority: 0.6, changeFrequency: 'monthly', lastModified: '2026-07-30' },

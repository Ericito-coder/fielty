...
export default function sitemap() {
  ...
  const routes = [
    ...
    { path: '/para/barberias', priority: 0.9, changeFrequency: 'monthly', lastModified: '2026-08-01' },
    { path: '/para/cafeterias', priority: 0.9, changeFrequency: 'monthly', lastModified: '2026-08-01' },
    { path: '/para/peluquerias', priority: 0.9, changeFrequency: 'monthly', lastModified: '2026-08-01' },
    { path: '/para/veterinarias', priority: 0.9, changeFrequency: 'monthly', lastModified: '2026-08-01' },
    { path: '/para/gimnasios', priority: 0.9, changeFrequency: 'monthly', lastModified: '2026-08-01' },

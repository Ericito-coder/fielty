...
function camposPresentacion(negocio) {
  return {
    ...
    // El de 1024 y no el de 512: cuando Wallet llegue al plan gratis este
    // fallback deja de ser un caso borde y pasa a ser lo que ve el cliente
    // de todo negocio gratis, que no puede subir logo propio
    // (`puedeSubirLogo = esPago`). En pantallas de 3x, 512 se ve blando.
    programLogo: { sourceUri: { uri: negocio.logo_url || `${APP_URL}/icons/icon-1024.png` } },
